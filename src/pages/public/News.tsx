...
export default function News() {
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-16 pb-28 md:px-8 lg:pb-16">
      <p className="eyebrow text-grass">News</p>
      <h1 className="mt-2 text-4xl text-pitch md:text-5xl">Academy news &amp; announcements</h1>

      {loading ? (
        <div className="mt-10 h-32 animate-pulse rounded-card bg-line-soft/20" />
      ) : announcements.length === 0 ? (
        <div className="mt-10">
          <EmptyState title="No announcements yet" hint="Academy news and updates will appear here." />
        </div>
      ) : (
